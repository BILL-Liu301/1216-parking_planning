...
if __name__ == '__main__':
    ...
    # trainer.fit(model=model_lighting, train_dataloaders=Parking_Trajectory_Planner_Dataset['dataset_loader_train'],
    #             val_dataloaders=Parking_Trajectory_Planner_Dataset['dataset_loader_val'])
