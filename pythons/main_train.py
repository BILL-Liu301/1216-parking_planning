...
from api.base.paras import num_step
...
if __name__ == '__main__':
    ...
    for step in range(num_step):
        ...
        trainer = pl.Trainer(log_every_n_steps=1, max_epochs=paras_Parking_Trajectory_Planner['max_epochs'],
        ...
        # 加载已有模型
        if os.path.exists(path_ckpts):
            ckpt_path = path_ckpts + f'version_{step - 1}/checkpoints/'
