...
from api.base.paths import path_ckpt_best_version, path_ckpts, path_figs_test, path_dataset, path_base
...
if __name__ == '__main__':
    ...
    # 设置训练器
    trainer = pl.Trainer(default_root_dir=path_base, accelerator='gpu', devices=1)
    ...
    for i in tqdm(range(0, len(model_lighting.test_results), 1), desc='Test', leave=False, ncols=shutil.get_terminal_size().columns, disable=False):
